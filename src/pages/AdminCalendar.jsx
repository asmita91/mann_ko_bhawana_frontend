...
import { getAllCounselorsApi, getAllUsersApi } from "../apis/Api";
import AnimatedWave from "../components/AnimatedWave";
import ModalEventAdmin from "../components/ModalAdmin";
...
const AdminCalendar = () => {
  ...
  const handleEventClick = (event) => {
    ...
    const userName = userMap[event.userId];
